...
struct BookDetailView: View {
    ...
    var body: some View {
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                HStack(spacing: 12) {
                    ...
                    Label(
                        ...
                        systemImage: book.isRead ? "checkmark.circle.fill" : "circle"
                    )
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text(
                        ...
                        ? "No description or notes were added."
                        : book.description
                    )
                    .font(.body)
                    .foregroundStyle(.secondary)
        ...
        .sheet(isPresented: $showShareSheet) {
            ActivityView(
                activityItems: ["\(book.title) by \(book.author)"]
            )
        }
    }
}
...
#Preview {
    @Previewable @State var book = Book(
        title: "Preview Book",
